/*************************************************************************
    ...
    > Created Time: 2019年03月29日 星期五 21时34分33秒
 ************************************************************************/
#ifndef DATA_H
#define DATA_H
...
extern char ok[];//="OK";
extern char bad_request[];//="Bad Request";
extern char forbidden[];//="Forbiddend";
extern char not_found[];//="Not Found";
extern char no_implemented[];//="No Implemented";
